            ...
            class="mws-datatable-fn mws-table dataTable">
                <thead>
                    <tr role="row">
                        ...
                        aria-sort="ascending" style="width: 50px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_1"
                        tabindex="0" role="columnheader" class="sorting_asc">
                            ID
                        </th>
                        <th aria-label="Browser: activate to sort column ascending" style="width: 150px;"
                        ...
                        <th aria-label="Browser: activate to sort column ascending" style="width: 200px;"
                        colspan="1" rowspan="1" aria-controls="DataTables_Table_1" tabindex="0"
                        role="columnheader" class="sorting">
                            邮箱
                        </th>
...
$('.bb').click(function(){
    ...
    $.post("{{ url('/admin/user/work') }}", {_token:'{{ csrf_token() }}', id:ids, status:status}, function(data){
